...
> 2026-08-14 补充：人物身份参考已升级为“图像 2 唯一身份来源”强协议，输入排序、生成前保存、模型能力校验和人工验收见 [分镜生图唯一人物身份来源协议](../../architecture/generation/Phase2_分镜生图唯一人物身份来源协议.md)。
...
完整操作步骤见 `docs/archive/phase-2/Phase2_Batch4.4.4_4.4.5与4.2.4_人工验收.md`。
